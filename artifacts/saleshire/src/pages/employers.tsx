import { ArrowRight, ClipboardCheck, Eye, MessageSquareText, ShieldCheck } from 'lucide-react';
...
export default function Employers() {
  return (
    <PageFrame>
      ...
      <section className="employer-proof"><div className="proof-quote"><span className="quote-mark">“</span><blockquote>Dobří obchodníci nepotřebují další portál. Potřebují vědět, že role dává smysl.</blockquote><span className="quote-caption">— princip SalesHire</span></div><div className="proof-aside"><Eye size={22} /><strong>Viditelnost, která dává smysl</strong><p>Vaše pozice se dostane před lidi, kteří aktivně hledají sales práci — ne před náhodné kliky.</p></div></section>
